...
class _AddProductPageWidgetState extends State<AddProductPageWidget> {
  ...
  void initState() {
    ...
    _model.productionCostTextFieldFocusNode ??= FocusNode();
    ...
    _model.imageTextFieldFocusNode ??= FocusNode();
                        ...
                        onPressed: () async {
                          setState(() {
                            FFAppState().addToProducts(ProductStruct(
                              id: FFAppState().products.length++,
                              name: _model.nameTextFieldController.text,
                              price: double.tryParse(
                                  _model.priceTextFieldController.text),
                              productionCost: double.tryParse(_model
                                  .productionCostTextFieldController.text),
